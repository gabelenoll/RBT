...
function fnIdentity(o){return o;}
function fnVoid(){}

function fnCreateTraitsCaller(sClass, ioTraits) {
  return ioTraits != null
    ? function(sFunction, oParameters) {
        for(var oTrait of ioTraits) {
          var fn = oTrait[sFunction];
          if(fn != null)
            fn(sClass, oParameters); }}
    : fnVoid ;}
...
export {
  ...
  fnGetId as getId,
  fnCreateTraitsCaller as createTraitsCaller,
